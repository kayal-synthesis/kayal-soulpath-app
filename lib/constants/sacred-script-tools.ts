...
//
// These are ongoing AI dialogue subscriptions, not one-time
// readings. Voice standard: plain, human, specific. Copy is
// framed around continuity and permanent context, which is the
// real value proposition here.
//
// CONSTRAINT: whatYouGet has exactly 8 items per tool.
//
// v1.2: All user-facing copy polished to match the gold standard
// used across every other domain. IDs preserved (they are
// referenced as upsell targets across love, wealth, wellness,
// and other domains). The life-scribe upsell was pointing at a
// stale life-path ID, now corrected to core-pattern-reading.
// ============================================================
...
// already-working logic, not re-derived independently, so this
// file's domainScope data can never quietly drift out of sync
// with what the chat interface itself actually enforces.
...
// Real, functional placeholder, not a verified original value.
// The all-domain flagship gets a higher cap than single-domain
// scribes. Worth real review rather than trusting as-is.
...
export const sacredScriptTools: SacredScriptTool[] = [
  {
    ...
    rating: 4.9,
    reviewCount: 2456,
    hook: "Most advice forgets you the moment the talk ends. This one remembers your full pattern every time, checks what's already worked, and gives you real answers to any question.",
    whatYouGet: [
  ...
  },
  {
    ...
    domain: 'sacred-script',
    subscriptionPeriod: 'month',
    hook: "Love questions rarely get solved in one talk. This chat remembers your history, checks what's already worked, and gives you real steps every time you return.",
    whatYouGet: [
  ...
  },
  {
    ...
    domain: 'sacred-script',
    subscriptionPeriod: 'month',
    hook: "Money decisions build on each other. This chat remembers your pattern, checks what's worked before, and gives you real steps for every new question.",
    whatYouGet: [
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 1893,
    hook: "Spiritual growth is rarely a straight line. This chat remembers your journey, checks what's actually helped, and gives you real practices, not just reflection.",
    whatYouGet: [
  ...
  },
  {
    ...
    domain: 'sacred-script',
    subscriptionPeriod: 'month',
    hook: "What worked last month should shape what you try this month. This chat remembers your body pattern, checks what's already helped, and gives you real steps.",
    whatYouGet: [
  ...
  },
  {
    ...
    domain: 'sacred-script',
    subscriptionPeriod: 'month',
    hook: "Questions about purpose keep returning at every crossroad. This chat remembers your pattern, checks what's held true before, and helps you see the real answer.",
    whatYouGet: [
  ...
  },
  {
    ...
    domain: 'sacred-script',
    subscriptionPeriod: 'month',
    hook: "This chat stays focused on one relationship. It remembers the real history, checks what's already been tried, and gives you real steps each time.",
    whatYouGet: [
  ...
  },
  {
    ...
    rating: 4.9,
    reviewCount: 1204,
    hook: "Grief doesn't move in a straight line. This chat remembers where you are, checks how things have shifted, and offers real support built for this exact stage.",
    whatYouGet: [
  ...
  },
  {
    ...
    domain: 'sacred-script',
    subscriptionPeriod: 'month',
    hook: "Parenting questions rarely wait for research time. This chat remembers your child and your pattern, checks what's worked before, and gives you real answers fast.",
    whatYouGet: [
  ...
  },
  {
    ...
    domain: 'sacred-script',
    subscriptionPeriod: 'month',
    hook: "One business choice shapes the next. This chat remembers your company's real pattern, checks what's worked, and gives you real answers, not fresh guesses.",
    whatYouGet: [
...
// ─────────────────────────────────────────────────────────────
// v1.2, real, required exports, previously imported by
// ChatSession.tsx but never defined, now stable.
// ─────────────────────────────────────────────────────────────
...
export function getMemoryInstruction(tool: SacredScriptTool): string {
  return "Treat this conversation as continuous with everything discussed in past sessions. Reference what's already been said or tried where genuinely relevant, rather than treating each message as a fresh start."
}