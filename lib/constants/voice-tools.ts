...
export const voiceTools: VoiceTool[] = [
  {
    ...
    upsell: { id: 'oracle-deep-dive-session', name: 'The Deep Dive', price: 44 },
  },
  {
    ...
    upsell: { id: 'oracle-voice-unlimited', name: 'Unlimited Talk', price: 79 },
  },
  {
  ...
  },
  {
    ...
    upsell: { id: 'oracle-voice-session', name: 'Ask Me Anything', price: 29 },
  },
  {
    id: 'relationship-oracle-session',
    name: 'Talk Relationships',
  ...
  },
  {
    ...
    name: 'The SOS Line',
    tagline: 'A live call built for a genuinely difficult moment, grounded and direct',
    emoji: '🆘',
    price: 34,
    domain: 'voice',
    subscriptionPeriod: 'month',
  ...
  },
  {
    ...
    name: 'Unlimited Talk',
    tagline: 'Unlimited live calls, any question, any time',
    emoji: '♾️',
    price: 79,
    domain: 'voice',
    subscriptionPeriod: 'month',
