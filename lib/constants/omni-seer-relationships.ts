...
//
// This file: Love (3), Family (4), and the relationship-adjacent
// additions (health cross-impact, marriage longevity score, the
// two-person flagship).
//
...
export const omniRelationshipTools: OmniSeerTool[] = [
  {
    ...
    rating: 4.9,
    reviewCount: 2341,
    hook: "Most love readings look at one angle. This one checks your pattern across several real systems at once, so what you get is confirmed, not guessed.",
    whatYouGet: [
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 1567,
    hook: "A percentage score doesn't tell you the real story. This reading checks both of your real patterns and gives you a clear, honest verdict.",
    whatYouGet: [
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 892,
    hook: "Romantic compatibility and business compatibility aren't the same question. This reading checks your real working styles before real money is on the line.",
    whatYouGet: [
  ...
  },
  {
    ...
    whatYouGet: [
      ...
      "One real thing this child is naturally good at, even if it isn't obvious yet",
