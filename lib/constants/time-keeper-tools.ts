...
//
// Escalating cascade by design: daily, monthly, quarterly,
// annual, long-view. Each tool upsells into the next.
//
// CONSTRAINT: whatYouGet counts preserved per tool.
// today-reading: 7 | month-reading: 8 | season-reading: 8
// year-reading: 8 | long-view-reading: 9
// ============================================================
...
export const timeKeeperTools: TimeKeeperTool[] = [
  {
    ...
    rating: 4.9,
    reviewCount: 4231,
    hook: "Every day carries its own real shape. This reading tells you what today is asking, whether it's building or easing, and checks how it compares to yesterday.",
    whatYouGet: [
    ...
    upsell: { id: 'month-reading', name: 'Your Month, Mapped Before It Starts', price: 29 },
  },
  {
    id: 'month-reading',
    ...
    upsell: { id: 'season-reading', name: 'Your Next Ninety Days, Mapped', price: 37 },
  },
  {
    id: 'season-reading',
    ...
    upsell: { id: 'year-reading', name: 'Your Whole Year, Mapped Before It Starts', price: 47 },
  },
  {
    id: 'year-reading',
    ...
    upsell: { id: 'long-view-reading', name: 'The Next Nine Years of Your Life', price: 57 },
  },
  {
