    ...
    >
      ...
      >
        ...
        <div className="p-6 pb-10">
          ...
          <h3 className="text-2xl font-serif text-neutral-900 text-center mb-1">Begin Your Journey</h3>
          <p className="text-sm text-neutral-400 text-center mb-6">Choose how you would like to proceed with KAYAL</p>
          <div className="space-y-3">
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-neutral-500 mt-0.5">Join structured learning programs and master your path</p>
              </div>
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-neutral-500 mt-0.5">One-on-one session with a KAYAL guide for deep insights</p>
              </div>
          ...
          <button onClick={onClose} className="w-full mt-4 py-3 text-xs text-neutral-400 hover:text-neutral-600 transition">
            Maybe later
          </button>
        </div>
      </div>
