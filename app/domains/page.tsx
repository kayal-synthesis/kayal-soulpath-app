...
import { wellnessTools }     from '@/lib/constants/wellness-spiritual'  // was spiritualTools + healthTools
...
const domains = [
  ...
  },
  {
    ...
    icon:        '🎙️',
    description: 'Live voice conversations with an AI oracle that has read your complete synthesis. Ask anything and hear your answer spoken back with your full chart as context.',
  ...
  },
  {
    ...
    name:        'Sacred Script',
    icon:        '📜',
    description: 'Deep written dialogue with a sacred scribe trained on your complete synthesis. Ask complex questions and receive nuanced, chart-grounded answers.',
  ...
  },
  {
    ...
    name:        'Eternal Clock',
    icon:        '⏰',
    description: 'Subscription forecasting across five timescales — daily, monthly, quarterly, annual, and nine-year arc. Wake every morning knowing what the day is asking of you.',
  ...
  },
  {
    ...
    name:        'Wealth & Career',
    icon:        '💰',
    description: 'Abundance manifestation tools for financial freedom and career success. Unlock your wealth blueprint, break your income ceiling, and build with cosmic alignment.',
    toolCount:   wealthTools.length,
  ...
  },
  {
    ...
    icon:        '🌙',
    description: 'Comprehensive spiritual growth and wellness tools for awakening. Explore shadow work, ancestral healing, and activate your spiritual gifts.',
    toolCount:   wellnessTools.length,
  ...
  },
  {
    ...
    icon:        '🌟',
    description: "Decode your soul contract, map your pinnacles, understand your karma, and step into your full purpose. Discover why you're here.",
    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <Card className="p-4">
            <p className="text-2xl font-bold text-green-600">{totalTools}</p>
          ...
          {filteredDomains.map((domain, index) => (
            ...
            >
              ...
              >
                ...
                <Button className="w-full group-hover:bg-primary-700 transition" size="sm">
                  Explore Domain
