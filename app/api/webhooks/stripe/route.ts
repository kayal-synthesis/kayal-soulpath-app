...
import { REFERRAL_BONUS_RATE } from '@/lib/affiliate/affiliate-commission'
...
// Real, single, shared implementation, lib/affiliate/credit-purchase-commission.ts,
// the exact same functions app/api/user/add-purchase/route.ts now
// also imports, never two, separate copies of the same, real,
// money-calculating logic that could quietly drift apart from each
// other over time.
